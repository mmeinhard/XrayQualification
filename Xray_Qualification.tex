...
\footnotetext{Please note that these tests are implemented differently for L1 and L2 module tests. The test procedure remains the same for both types of modules. Tests for L1 modules are found in the XPixelAlive2 tab of \textbf{pXar} and for L2 in the HighRate one. Make the necessary modifications in the \textbf{home/production/ElCommandanteXray/config/tests/} files.} 
...
\begin{minipage}[t]{.48\textwidth}
  ...
  \captionof{figure}{ROC map showing the number of hits acquired per pixel.}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Map showing the measured threshold of every pixel.}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Distribution of the threshold of every pixel.}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Distribution of the noise of all pixels.}
...
\begin{minipage}[t]{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of ROC 0 with the first tested CalDel.}
  \label{CalDel-Step0}
\end{minipage}
\end{figure}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of ROC 0 with the sixth tested CalDel.}
  \label{CalDel-Step5}
\end{minipage}%
\hspace{2mm}
\begin{minipage}{.48\textwidth}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of all ROCs at \SI{50}{\mega\hertz}.}
  \label{Efficiency50}
\end{minipage}%
\hspace{2mm}
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of all ROCs at \SI{120}{\mega\hertz}.}
  \label{Efficiency120}
\end{minipage}
\end{figure}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Offset of the Vcal calibration.}
  \label{Offset}
\end{minipage}%
\hspace{2mm}
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Slope of the Vcal calibration.}
  \label{Slope}
\end{minipage}
\end{figure}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of all ROCs at \SI{150}{\mega\hertz}.}
  \label{Efficiency150}
\end{minipage}%
\hspace{2mm}
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Efficiency of all ROCs at \SI{300}{\mega\hertz}.}
  \label{Efficiency300}
\end{minipage}
\end{figure}
\end{itemize}
...
\begin{minipage}{.48\textwidth}
  ...
  \captionof{figure}{Casing of the filter removed from the front plate.}
  \label{holder}
\end{minipage}
\end{figure}
...
\end{tabular}
\end{table}
\footnotetext[4]{only for L2 modules}
\footnotetext{\SI{120}{\mega\hertz\per\centi\meter\square} for L2 and \SI{300}{\mega\hertz\per\centi\meter\square} for L1 modules}

\section{ElCommandante configuration files}  \label{Config}
The only files that need to be modified are the \textbf{./config/elComandante.conf} and the \textbf{./config/elComandante.ini} files. The first of those is used to indicate which port is occupied by the different devices steered by \textbf{elCommandante}. In the second one, details about which tests are to be executed and under which conditions (temperature, X-ray hit rate) should be indicated.
Please note that for readability reasons some lines in the following examples are split into several lines. For testing, this change needs to be reverted.
\subsection{L1}
elCommandante.ini:
